  ...
  return (
    <>
      ...
      <div className="container">
        <h2 className="MR" style={{ marginBottom: "449px" }}>
          Manage Request
        </h2>
          ...
          <tbody>
            {requests.map((request, i) => (
              <tr key={i}>
                ...
                <td><Link to={'user/'+request.user_id}>{GetUserName(request.user_id)}</Link></td>
                <td><Link to={'book/'+request.book_id}>{GetBookName(request.book_id)}</Link></td>
